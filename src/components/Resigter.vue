<template>
 <div class="middle-box text-center">
    ...
    <div style="width:8.33rem;margin:0 auto;padding-top:3.08rem;display: none;" class="reg" >
    ...
    <div class="name" style="width:8.33rem;margin:0 auto;padding-top:3.08rem;display: block;">
